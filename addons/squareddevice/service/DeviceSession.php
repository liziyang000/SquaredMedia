...
namespace addons\squareddevice\service;
...
class DeviceSession
{
    ...
    const TOKEN_COOKIE = 'squared_media_device_token';
    const TABLE = 'squared_media_device_session';
    ...
    {
        $config = function_exists('get_addon_config') ? get_addon_config('squareddevice') : [];
