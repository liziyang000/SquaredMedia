...
- `template/squaredmedia/js/squared-media-player.js`
- `template/squaredmedia/js/hls.min.js`
- `.sm-player` styles in `template/squaredmedia/css/style.css`

These templates currently do not load the player scripts:

- `template/squaredmedia/html/vod/play.html`
- `template/squaredmedia/html/vod/player.html`
...
- `docs/superpowers/specs/2026-07-01-squared-media-player-design.md`
- `docs/superpowers/plans/2026-07-01-squared-media-player.md`

Both documents were updated to note that the player is currently retained for later development and is not active.

## Implementation Notes

`squared-media-player.js` currently:
