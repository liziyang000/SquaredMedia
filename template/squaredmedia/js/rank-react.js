(function (window, document) {
  ...
  function mount(root) {
    if (!root || root.__squaredMediaRankRoot) return;
    ...
    root.__squaredMediaRankRoot = ReactDOM.createRoot(root);
    root.__squaredMediaRankRoot.render(createElement(RankPanel, {
      initialItems: items,
      title: title,
      moreUrl: moreUrl
    }));
