(function () {
  var PLAYER_READY_ATTR = "data-sm-player-ready";
  var PROGRESS_PREFIX = "squared_media_player_progress_";
  ...
  function createPlayerShell(sourceUrl) {
    ...
    player.className = "sm-player";
    player.tabIndex = 0;
    player.setAttribute("data-sm-player", "");

    var video = document.createElement("video");
    video.className = "sm-player-media";
    ...
    overlay.className = "sm-player-overlay";

    var status = document.createElement("div");
    status.className = "sm-player-status";
    status.setAttribute("role", "status");
    status.setAttribute("aria-live", "polite");
    status.textContent = "准备播放";

    var controls = document.createElement("div");
    controls.className = "sm-player-controls";

    var playButton = createButton("sm-player-button sm-player-play", "播放", "▶");
    var muteButton = createButton("sm-player-button sm-player-mute", "静音", "音");

    var time = document.createElement("span");
    time.className = "sm-player-time";
    time.textContent = "0:00 / 0:00";

    var progress = document.createElement("input");
    progress.className = "sm-player-progress";
    progress.type = "range";
    progress.min = "0";
    progress.max = "100";
    progress.step = "0.1";
    ...
    volume.className = "sm-player-volume";
    volume.type = "range";
    volume.min = "0";
    volume.max = "1";
    volume.step = "0.05";
    ...
    speed.className = "sm-player-speed";
    ...
    var fullscreenButton = createButton("sm-player-button sm-player-fullscreen", "全屏", "⛶");
