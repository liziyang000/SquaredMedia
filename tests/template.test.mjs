...
const rankIndexRule = style.match(/\.rank-index\s*\{[\s\S]*?\}/)?.[0] || "";
const rankBodyRule = style.match(/\.rank-body\s*\{[\s\S]*?\}/)?.[0] || "";
...
assert.match(heroCarouselRule, /grid-template-rows: minmax\(0, auto\) auto/);
...
assert.match(heroRankRule, /display: flex/);
assert.match(heroRankRule, /flex-direction: column/);
assert.match(heroRankRule, /min-height: 0/);
assert.match(heroRankRule, /padding: 22px 26px/);
...
assert.match(rankItemRule, /padding: 14px 0/);
...
assert.match(heroSlideRule, /grid-template-columns: minmax\(0, 1fr\) minmax\(220px, 278px\)/);
assert.match(heroSlideRule, /grid-template-areas: "content art"/);
assert.match(heroSlideRule, /position: absolute/);
assert.match(heroSlideRule, /gap: 28px/);
...
assert.match(bannerArtRule, /place-items: center end/);
assert.match(bannerPosterRule, /justify-self: end/);
assert.match(bannerPosterRule, /width: min\(100%, 240px\)/);
assert.match(bannerCopyRule, /max-width: 680px/);
...
assert.match(bannerControlsRule, /position: relative/);
assert.match(bannerControlsRule, /justify-content: flex-end/);
assert.match(bannerControlsRule, /padding: 0 42px 34px/);
assert.doesNotMatch(bannerControlsRule, /position: absolute/);
...
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.banner-controls\s*\{[\s\S]*padding: 0 18px 18px/);
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.banner-controls\s*\{[\s\S]*transform: none/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 0/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-slide\s*\{[\s\S]*padding: 20px 14px 18px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-content\s*\{[\s\S]*min-height: 340px/);
assert.doesNotMatch(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel \.hero-stats/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-controls\s*\{[\s\S]*padding: 0 14px 14px/);
