...
assert.match(style, /\.hero \.wrap\s*\{[\s\S]*width: min\(1500px, calc\(100vw - 48px\)\)/);
...
assert.match(heroRankRule, /border-color: rgba\(38, 212, 175, 0\.24\)/);
...
assert.match(rankItemRule, /border-bottom: 1px solid rgba\(255, 255, 255, 0\.075\)/);
