...
const recordTitleRule = style.match(/\.record-title\s*\{\s*overflow: hidden[\s\S]*?\}/)?.[0] || "";
...
assert.match(heroRankRule, /grid-template-rows: auto repeat\(6, minmax\(0, 1fr\)\)/);
assert.match(heroRankRule, /min-height: 500px/);
assert.match(heroRankRule, /padding: 22px 26px/);
assert.match(rankItemRule, /min-height: 0/);
assert.match(rankItemRule, /padding: 0/);
...
assert.match(heroSlideRule, /grid-template-columns: minmax\(0, 1fr\) 278px/);
assert.match(heroSlideRule, /grid-template-rows: minmax\(0, 1fr\)/);
assert.match(heroSlideRule, /gap: 36px/);
assert.match(bannerPosterRule, /position: absolute/);
assert.match(bannerPosterRule, /right: 42px/);
assert.match(bannerPosterRule, /top: 50%/);
assert.match(bannerPosterRule, /transform: translateY\(-50%\)/);
assert.match(bannerCopyRule, /height: 100%/);
assert.match(bannerCopyRule, /min-height: 0/);
assert.match(bannerCopyRule, /max-width: none/);
assert.match(bannerCopyRule, /padding: 44px 0 44px 42px/);
...
assert.match(heroCarouselStatsRule, /display: grid/);
assert.match(heroCarouselStatsRule, /position: absolute/);
assert.match(heroCarouselStatsRule, /left: 42px/);
assert.match(heroCarouselStatsRule, /right: 320px/);
assert.match(heroCarouselStatsRule, /bottom: 34px/);
assert.match(heroCarouselStatsRule, /max-width: 420px/);
assert.match(bannerControlsRule, /right: 42px/);
assert.match(bannerControlsRule, /bottom: 34px/);
...
assert.match(style, /\.hero-carousel \.hero-stats\s*\{[\s\S]*display: grid/);
...
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.hero-carousel \.hero-stats\s*\{[\s\S]*bottom: 72px/);
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.banner-controls\s*\{[\s\S]*min-height: 52px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 400px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-copy\s*\{[\s\S]*padding: 20px 14px 148px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel \.hero-stats\s*\{[\s\S]*bottom: 60px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-controls\s*\{[\s\S]*bottom: 6px/);
...
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 430px/);
