...
assert.match(heroRankRule, /grid-template-rows: auto/);
assert.match(heroRankRule, /align-content: start/);
assert.match(heroRankRule, /min-height: 500px/);
assert.match(heroRankRule, /padding: 22px 26px/);
assert.match(rankItemRule, /min-height: 56px/);
assert.match(rankItemRule, /padding: 8px 0/);
...
assert.match(bannerPosterRule, /height: 315px/);
assert.match(bannerPosterRule, /margin-right: 42px/);
assert.match(bannerCopyRule, /height: 100%/);
assert.match(bannerCopyRule, /min-height: 0/);
assert.match(bannerCopyRule, /max-width: none/);
assert.match(bannerCopyRule, /padding: 44px 0 88px 42px/);
...
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 500px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-copy\s*\{[\s\S]*padding: 20px 14px 90px/);
...
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 500px/);
