...
const filterScrollbarRule = extractCssRule(style, ".filter-options::-webkit-scrollbar");
...
assert.match(filterOptionsRule, /overflow-x: auto/);
assert.match(filterOptionsRule, /scrollbar-width: none/);
assert.match(filterScrollbarRule, /display: none/);
assert.match(filterScrollbarRule, /height: 0/);
...
assert.doesNotMatch(extractCssRule(style, ".liquid-lens"), /will-change/);
