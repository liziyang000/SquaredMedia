...
assert.match(heroCarouselStatsRule, /display: none/);
...
assert.match(style, /\.hero-carousel \.hero-stats\s*\{[\s\S]*display: none/);
...
assert.match(style, /@media \(max-width: 760px\)[\s\S]*\.banner-controls\s*\{[\s\S]*min-height: 44px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel\s*\{[\s\S]*min-height: 400px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-copy\s*\{[\s\S]*padding: 22px 14px 80px/);
assert.doesNotMatch(style, /@media \(max-width: 520px\)[\s\S]*\.hero-carousel \.hero-stats\s*\{[\s\S]*bottom: 60px/);
assert.match(style, /@media \(max-width: 520px\)[\s\S]*\.banner-controls\s*\{[\s\S]*bottom: 14px/);
