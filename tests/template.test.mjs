...
assert.match(head, /class="hot-search-panel"/);
assert.match(head, /热搜榜/);
assert.match(head, /\$maccms\.search_hot/);
assert.match(head, /\{maccms:foreach name=":explode\(',',\$maccms\.search_hot\)" id="vo2"/);
assert.match(head, /mac_url\('vod\/search',\['wd'=>\$vo2\]\)/);
...
assert.match(searchPage, /class="hot-search-panel search-hot-panel"/);
assert.match(searchPage, /\$maccms\.search_hot/);
assert.match(searchPage, /mac_url\('vod\/search',\['wd'=>\$vo2\]\)/);
