...
assert.match(include, /css\/style\.css\?v=20260626a/);
...
assert.match(foot, /js\/gsap\.min\.js\?v=3\.15\.0[\s\S]*js\/app\.js\?v=20260626a/);
assert.doesNotMatch(foot, /js\/app\.js\?v=20260621/);
assert.match(foot, /js\/app\.js\?v=20260626a/);
...
assert.match(userPlaysPage, /loading="lazy" decoding="async" width="160" height="240"/);
...
assert.match(userFavsPage, /loading="lazy" decoding="async" width="160" height="240"/);
...
assert.match(detail, /class="detail-poster"[\s\S]*<img src="\{\$obj\.vod_pic\|mac_url_img\}" alt="\{\$obj\.vod_name\}" width="380" height="570" decoding="async" fetchpriority="high">/);
...
assert.match(detail, /loading="lazy" decoding="async" width="300" height="450"/);

const vodCard = readThemeFile("html/public/vod_card.html");
assert.match(vodCard, /<img src="\{\$vo\.vod_pic\|mac_url_img\}" alt="\{\$vo\.vod_name\}" loading="lazy" decoding="async" width="300" height="450">/);
...
assert.match(preview, /css\/style\.css\?v=20260626a/);
...
assert.match(preview, /js\/gsap\.min\.js\?v=3\.15\.0[\s\S]*js\/app\.js\?v=20260626a/);
