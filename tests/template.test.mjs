...
assert.match(qixiPage, new RegExp(`type="module" src="\\{\\$maccms\\.path_tpl\\}js/qixi-particle-rose\\.js\\?v=${qixiVersionPlaceholder}"`));
...
assert.match(style, /\.qixi-rose-credit/);
...
assert.match(style, /\.qixi-rose-page[\s\S]*env\(safe-area-inset-top, 0px\)[\s\S]*env\(safe-area-inset-bottom, 0px\)/);
...
assert.doesNotMatch(style, /\.qixi-rose-gesture/);
...
assert.match(qixiPreview, /type="module" src="\.\.\/template\/pingfangvideo\/js\/qixi-particle-rose\.js"/);
