...
assert.match(heroSlideRule, /min-height: clamp\(410px, 28vw, 480px\)/);
assert.match(heroSlideRule, /padding: 38px 46px 56px/);
assert.match(heroSlideRule, /gap: 38px/);
assert.match(activeHeroSlideRule, /position: relative/);
assert.match(bannerBgAfterRule, /rgba\(16, 17, 19, 0\.52\) 100%/);
...
assert.match(bannerControlsRule, /bottom: 18px/);
