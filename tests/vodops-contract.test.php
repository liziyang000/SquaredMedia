...
vodops_contract_match('/class="search-actions"[\s\S]*?url\(\'vodops\/index\',\[\'workspace\'=>\'douban\'\]\)[\s\S]*?清空筛选/', $doubanView, 'Operators must be able to clear all Douban search filters in one click.');
